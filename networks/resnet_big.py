...
if __name__ == "__main__":
	resnet101 = resnet101()
	param_num = sum(p.numel() for p in resnet101.parameters() if p.requires_grad)
	print('param num: resnet101', param_num) # resnet101 42492480
	from facenet_pytorch import InceptionResnetV1
	iresnetv1 = InceptionResnetV1()
	param_numv1 = sum(p.numel() for p in iresnetv1.parameters() if p.requires_grad)
	print(f'param num iresnetv1: {param_numv1}')  # iresnetv1: 23482624
	resnet50 = resnet50()
	param_num = sum(p.numel() for p in resnet50.parameters() if p.requires_grad)
	print('param num: resnet50', param_num) # resnet50 23500352
